...
namespace AttendanceEpiisBk.Modules.Product.Infraestructure.Controller;
...
public class ProductController : ControllerBase
{
    ...
    public ProductController(IEventInputPort eventInputPort, IEventOutPort eventOutPort)
    {
